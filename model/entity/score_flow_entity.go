...
const (
	FLOW_TYPE_INVITER             ScoreFlowType = 1
	FLOW_TYPE_EXCHANGE_AVATAR     ScoreFlowType = 2
	FLOW_TYPE_SUB_EXCHANGE_AVATAR ScoreFlowType = 3
	FLOW_TYPE_UNKNOWN             ScoreFlowType = -99
)

type ScoreFlow struct {
	Id          int64           `gorm:"primary_key"`
	AccountId   int64           `gorm:"type:bigint;not null;index:idx_accountId"`
	Amount      decimal.Decimal `gorm:"type:decimal(8,2);not null;default:0.0"`
